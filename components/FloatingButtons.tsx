  ...
  return (
    <div className="fixed bottom-8 right-0 z-50 flex flex-col gap-3">
      ...
      >
        ...
        <div className="relative w-11 h-11 rounded-full bg-[#1A1A1A] flex items-center justify-center transition-all duration-300 group-hover:bg-[#C9A96E] group-hover:shadow-lg shadow-[#C9A96E]/20 translate-x-[22px] group-hover:translate-x-0">
