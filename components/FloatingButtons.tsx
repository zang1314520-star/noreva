  ...
  return (
    <div className="fixed bottom-8 right-4 z-50 flex flex-col gap-3">
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="w-11 h-11 rounded-full bg-[#F5F4F2] flex items-center justify-center text-[#8A8A8A] hover:bg-[#1A1A1A] hover:text-white transition-all duration-300 shadow-sm"
      ...
      >
        ...
        <div className="relative w-11 h-11 rounded-full bg-[#1A1A1A] flex items-center justify-center transition-all duration-300 group-hover:bg-[#C9A96E] group-hover:shadow-lg shadow-[#C9A96E]/20">
