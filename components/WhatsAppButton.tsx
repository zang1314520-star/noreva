  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Button - 默认向右偏移隐藏，悬停时浮出完整圆形 */}
        <div className="relative w-12 h-12 rounded-full bg-[#1A1A1A] flex items-center justify-center transition-all duration-300 group-hover:bg-[#C9A96E] group-hover:shadow-lg group-hover:shadow-[#C9A96E]/20 translate-x-[calc(100%-8px)] group-hover:translate-x-0 hover:!translate-x-0">
