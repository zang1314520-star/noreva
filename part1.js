        ...
        {tab === "products" && (
          <div>
            <div className="bg-white rounded-xl p-6 shadow-sm mb-6">
              ...
              <div className="mb-4"><label className="text-sm text-gray-600">Description</label><textarea value={newP.description} onChange={(e) => setNewP({ ...newP, description: e.target.value 